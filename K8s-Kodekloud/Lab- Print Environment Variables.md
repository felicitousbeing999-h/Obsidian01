![[Pasted image 20260901204040.png]] **Kubernetes batch-style Pod pattern**: inject configuration through environment variables, execute a command, then terminate successfully.
